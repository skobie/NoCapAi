...
export default function Auth() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-slate-800 to-cyan-700 flex flex-col items-center justify-center p-6">
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-6 space-y-4">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <input
                ...
                required
                className="w-full px-5 py-4 bg-gray-100 border-0 rounded-2xl font-semibold text-gray-900 placeholder-gray-500 focus:ring-4 focus:ring-cyan-300 transition-all"
                placeholder="Email"
              />
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-gradient-to-r from-slate-800 to-cyan-600 hover:from-slate-900 hover:to-cyan-700 text-white font-black py-4 px-6 rounded-full text-lg shadow-lg transition-all transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {loading ? (
